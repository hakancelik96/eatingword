...
# def signal_known_words(sender, instance, action, reverse, model, pk_set, **kwargs):
# 	if action == "post_add":
# 		print("known_words")
# 		instance.unknown_words.remove(*pk_set)
# 		print(instance.unknown_words.all())


# @receiver(m2m_changed, sender=UserModel.unknown_words.through)
# def signal_unknown_words(sender, instance, action, reverse, model, pk_set, **kwargs):
# 	if action == "post_add":
# 		print("unknown_words")
# 		instance.known_words.remove(*pk_set)
# 		print(instance.known_words.all())
